...
//const ABOUT_ME = "Après avoir travaillé dans le domaine de l'informatique durant environ 3 ans en tant que développeur Odoo je cherche à me diversifier et souhaite travailler en tant que développeur full stack (je reste ouvert à toute autre opportunité). Véritable couteau suisse, je m'adapte rapidement aux nouveaux environnements et aucune tache ne me fait peur.";
const ABOUT_ME_ENG = "After working in the field of computer science for about 3 years as an Odoo developer I am looking to diversify and work as a full stack developer (I remain open to any other opportunity). I am a real Swiss Army knife, I can adapt quickly to new environments and no task scares me.";
